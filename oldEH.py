...
def chart_view():
    ...
    if p_name.get() == "mobile":
        if p_brand.get() == "Redmi":
            f = r'H:\DS&DV_PROJECT\data_scraping\exceldata\redmi_rating.csv'        
        elif p_brand.get() == "Samsung":
            f = r'H:\DS&DV_PROJECT\data_scraping\exceldata\samsung_rating.csv'
        elif p_brand.get() == "Iphone":
            f = r'H:\DS&DV_PROJECT\data_scraping\exceldata\iphone_rating.csv'
    elif p_name.get() == "laptop":
        if p_brand.get() == "Dell":
            f = r'H:\DS&DV_PROJECT\data_scraping\exceldata\dell_rating.csv'
        elif p_brand.get() == "HP":
            f = r'H:\DS&DV_PROJECT\data_scraping\exceldata\hp_rating.csv'
        elif p_brand.get() == "Lenovo":
            f = r'H:\DS&DV_PROJECT\data_scraping\exceldata\lenovo_rating.csv'
    elif p_name.get() == "tv":
        if p_brand.get() == "Sony":
            f = r'H:\DS&DV_PROJECT\data_scraping\exceldata\sonytv_rating.csv'
        elif p_brand.get() == "Samsung":
            f = r'H:\DS&DV_PROJECT\data_scraping\exceldata\samsungtv_rating.csv'
        elif p_brand.get() == "LG":
            f = r'H:\DS&DV_PROJECT\data_scraping\exceldata\lgtv_rating.csv'            
    if f:
        try:
            df = pd.read_csv(f)
